...
export default function ValorantMapSelector() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#141110] to-[#6E4A2A] text-white font-chakra">
      <h1 className="text-6xl font-extrabold text-center py-6 uppercase">
        Valorant Lineup Selector
      </h1>
        ...
        {maps.map((map) => (
          ...
          >
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold uppercase drop-shadow-lg">
                {map.name}
              </h2>
            </div>
          </div>
      ...
      {showAgentOverlay && (
        <div className="fixed inset-0 bg-accent/90 flex items-center justify-center z-50 p-6 font-chakra">
